        ...
        sealed class Perk(id: String, name: String, val maxLevel: Int, slotNum: Int) : HOTMSlot(id, name, slotNum) {
            ...
            object LonesomeMiner : Perk("lonesome_miner", "Lonesome Miner", 45, 11) {
                override fun getLore(level: Int) = listOf("§7Increases §c❁ Strength, §9☣ Crit",
                        ...
                        "§7statistics gain by §a${round(5 + (level - 1) * 0.5)}%",
                        "§7while in the Crystal Hollows.")
            }
            object Professional : Perk("professional", "Professional", 140, 12) {
                override fun getLore(level: Int) = listOf("§7Gain §a+${(5 * level) + 50}§7 §6⸕ Mining", "§6Speed§7 when mining Gemstones.")
            }
            object Mole : Perk("mole", "Mole", 190, 13) {
                override fun getLore(level: Int): List<String> {
                    ...
                    return listOf("§7When mining hard stone, you have",
                            "§7a §a${percent}%§7 chance to mine §a${blocks}",
                            "§7adjacent hard stone block.")
                }
            }
            object Fortunate : Perk("fortunate", "Fortunate", 20, 14) {
                override fun getLore(level: Int) = listOf("§7Grants §a+${5 * level}§7 §6☘ Mining",
                    "§6Fortune§7 when mining Gemstone.")
            }
            object GreatExplorer : Perk("great_explorer", "Great Explorer", 20, 15) {
                override fun getLore(level: Int) = listOf("§7Grants §a+${20 + (level - 1) * 4}%§7 §7chance to","§7find treasure.")
            }
            object GoblinKiller : Perk("goblin_killer", "Goblin Killer", 1, 20) {
                override fun getLore(level: Int) = listOf(
                    "§7Killing a §6Golden Goblin",
                    "§7gives §2200 §7extra §2Mithril",
            ...
            object StarPowder : Perk("star_powder", "Star Powder", 1, 24) {
                override fun getLore(level: Int) = listOf("§7Mining Mithril Ore near §5Fallen","§5Crystals §7gives §a+3","§7extra Mithril Powder.")
            }
            object SkyMall : Perk("daily_effect", "Sky Mall", 1, 28) {
                override fun getLore(level: Int) = listOf(
                    "§7Every SkyBlock day, you receive",
                    "§7a random buff in the §2Dwarven Mines§7.",
                    "",
                    "§7Possible Buffs",
            ...
            object SeasonedMineman : Perk("mining_experience", "Seasoned Mineman", 100, 30) {
                override fun getLore(level: Int) = listOf("§7Increases your Mining", "§7experience gain by §a${(5 + level * 0.1).roundToPrecision(1)}%§7.")
            }
            ...
            object Orbiter : Perk("experience_orbs", "Orbiter", 80, 32) {
                override fun getLore(level: Int) = listOf("§7When mining ores, you have a", "§a${(0.2 + level * 0.01).roundToPrecision(2)}%§7 chance to get a random", "§7amount of experience orbs.")
            }
            object FrontLoaded : Perk("front_loaded", "Front Loaded", 1, 33) {
                override fun getLore(level: Int) = listOf("§7Grants §a+100 §6⸕ Mining Speed", "§7and §6☘ Mining Fortune §7for", "§7the first §e2,500 §7ores you", "§7mine in a day.")
            }
            object PrecisionMining : Perk("precision_mining", "Precision Mining", 1, 34) {
                override fun getLore(level: Int) = listOf("§7When mining ore, a particle", "§7target appears on the block that", "§7increases your §6⸕ Mining Speed", "§7by §a30% §7when aiming at it.")
            }
            object LuckOfTheCave : Perk("random_event", "Luck of the Cave", 45, 38) {
                override fun getLore(level: Int) = listOf("§7Increases the chance for you to", "§7trigger rare occurrences in", "§2Dwarven Mines §7by §a${5 + level}%§7.")
            }
            object DailyPowder : Perk("daily_powder", "Daily Powder", 100, 40) {
                override fun getLore(level: Int) = listOf("§7Gain §a${400 + (level - 1) * 36} Powder §7from the", "§7first ore you mine every day.", "§7Works for all Powder types.")
            }
            object Crystallized : Perk("fallen_star_bonus", "Crystallized", 30, 42) {
                override fun getLore(level: Int): List<String> {
                    val num = 20 + (level - 1) * 6
                    return listOf("§7Grants §a+${num} §6⸕ Mining", "§6Speed §7and a §a${num}% §7chance to", "§7deal §a+1 §7extra damage near", "§5Fallen Stars§7.")
                }
            }
            ...
            object MiningSpeed : Perk("mining_speed", "Mining Speed", 50, 58) {
                override fun getLore(level: Int) = listOf("§7Grants §a+${20 * level} §6⸕ Mining", "§6Speed§7.")
            }
        ...
        sealed class PickaxeAbility(id: String, name: String, slotNum: Int) : HOTMSlot(id, name, slotNum) {
            ...
            object MiningSpeedBoost : PickaxeAbility("mining_speed_boost", "Mining Speed Boost", 47) {
                override fun getLore(level: Int) = listOf(
                    ...
                    "§7Grants §a+${100 + level * 100}% §6⸕ Mining",
                    "§6Speed §7for §a${10 + level * 5}s§7."
                )
            }
            object Pickobulus : PickaxeAbility("pickaxe_toss", "Pickobulus", 51) {
                override fun getLore(level: Int) = listOf(
                    ...
                    "§7ores within a §a${if (level == 3) 3 else 2}§7 block",
                    "§7radius.",
