package com.ryanhcode.kopixel.extension.converter
...
internal inline fun <reified T> JsonObject.byConverter(key: String?=null) = JsonConverterDelegate<T>(T::class, this, key)
...
internal inline fun <reified T> JsonObject.byExternalList(key: String?=null) = JsonPropertyDelegate(this, key) { it.asJsonArray.map {
...
internal inline fun <reified T> JsonObject.byList(key: String?=null) = JsonPropertyDelegate(this, key) { it.asJsonArray.map {
...
internal fun <T : Enum<T>> JsonObject.byEnum(key: String?=null, klazz: KClass<out Enum<T>>) =    JsonPropertyDelegate<T>(this, key) { java.lang.Enum.valueOf(klazz.java, it.asString) as T }

@Suppress("UNCHECKED_CAST", "IMPLICIT_CAST_TO_ANY")
class JsonPropertyDelegate<T>(private val json: JsonObject, private val key: String?, private val lambda: (JsonElement)->T) {
